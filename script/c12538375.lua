...
-- Edison Format version: no more once per turn restriction
local s,id=GetID()
function s.initial_effect(c)
	...
	-- e1:SetCountLimit(1)
    -- With the  line above commented, the card now function properly in Edison Format, allowing it to be Special Summoned multiple timess during the same turn, as long as the conditions are met.
